var fn = function () {
  ...
  var translations = {
    ...
    de: {
      ...
      SEND: 'Absenden',
      CURRENT_STORAGE_TIME: 'Speicher aufgefüllt in',
      TOTAL_STORAGE_TIME: 'Maximale Zeit benötigt',
      NEXT_MOST_RENTABLE_BUILDS: 'Nächstbeste Investition',
      RENTABILITY_ASTRO: 'Erforsche die Astrophysik auf Stufe {level}, um eine neue Kolonie zu gründen.<br>Erhöhe die Stufe der Minen der neuen Kolonie auf {mineLevel}<br><br>Zeit für das Sammeln von Rohstoffen für Astrophysik: {astroTime}<br>Rohstoffkosten: {astroCost}<br><br>Zeit für das Sammeln von Rohstoffen für den Minenausbau: {mineEconomyTime}<br>Rohstoffkosten für Minenausbau: {mineCost}<br><br>Benötigte Zeit für den Ausbau der Minen der Kolonie: {mineTime}',
      RENTABILITY_MINE_METAL: '{coords} Erhöhe die Stufe deiner Metallmine auf {level}<br><br>Zeit für das Sammeln von Rohstoffen: {economyTime}<br>Rohstoffkosten: {totalCost}',
      RENTABILITY_MINE_CRYSTAL: '{coords} Erhöhe die Stufe deiner Kristallmine auf {level}<br><br>Zeit für das Sammeln von Rohstoffen: {economyTime}<br>Rohstoffkosten: {totalCost}',
      RENTABILITY_MINE_DEUTERIUM: '{coords} Erhöhe die Stufe dein Deuterium-Synthetisierer auf {level}<br><br>Zeit für das Sammeln von Rohstoffen: {economyTime}<br>Rohstoffkosten: {totalCost}',
