var fn = function () {
  ...
  window._addTabAlliance = function _addTabAlliance () {
    ...
    var tabhtml = [
      ...
      '<th><span class="navButton uipp-score tooltip" id="points" title="' + window._translate('POINTS') + '"></span></th>',
      '<th>⇵</th>',
      '<th><span class="navButton uipp-score tooltip" id="fleet" title="' + window._translate('MILITARY_SCORE') + '"></span></th>',
      '<th>⇵</th>',
      '<th class="menu_icon"><span class="menuImage active fleet1 tooltip" style="height: 27px; width: 27px; display: inline-block; margin-bottom: -5px;" title="' + window._translate('FLEET_NBR') + '"></span></th>',
      '<th>⇵</th>',
      '<th><span class="navButton uipp-score tooltip" id="economy" title="' + window._translate('ECONOMY_SCORE') + '"></span></th>',
      '<th>⇵</th>',
